...
/****加密解密****/
#define Encryption_Decryption(a,b)  ( (a)==(b) ? (a) : (~((a)&(b))&(b))|((a)&~(b)) )
...
static unsigned char Magic_num[]={// 256个，随机排序 每个数据都是唯一
		...
		0xbf,0x67,0x2d,0x8e,0x83,0xef,0x57,0x61,0xff,0x8f,0xcd,0xd1,0x1e,0x9c,0x16,0xe6,
		0x1d,0xf0,0x4a,0x77,0xd7,0xe8,0x39,0x33,0x74,0xf4,0x9f,0xa4,0x59,0x35,0xcf,0xd3,
		0x48,0x75,0xd9,0x2a,0xe5,0xc0,0xf7,0x2b,0x81,0x0e,0x5f,0xee,0x8d,0x7b,0x05,0x15,
		0x07,0x82,0x18,0x70,0x92,0x64,0x54,0xce,0xb1,0x85,0x69,0xf8,0x46,0x6a,0x04,0x73,
